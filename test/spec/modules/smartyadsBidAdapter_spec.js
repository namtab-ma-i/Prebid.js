...
describe('SmartyadsAdapter', () => {
  ...
  describe('isBidRequestValid', () => {
    it('Should return true if there are bidId, params and placement_id parameters present', () => {
  ...
  describe('interpretResponse', () => {
    ...
    it('Should interpret native response', () => {
      ...
      expect(dataItem).to.have.keys('requestId', 'cpm', 'clickUrl', 'impressionTrackers', 'title', 'image',
